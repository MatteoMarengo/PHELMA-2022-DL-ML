...
data = loadmat("D:/OneDrive/Documents/PostCPGE/PHELMA 2020-2023/BIOMED 2022-2023/Machine Learning/Sequence-4-SVM-Kmeans-PCA/Exercices/1.-SVM-basic-study/Data/ex6data1.mat")
X, y = data['X'], data['y'][:, 0]
...
data = loadmat("D:/OneDrive/Documents/PostCPGE/PHELMA 2020-2023/BIOMED 2022-2023/Machine Learning/Sequence-4-SVM-Kmeans-PCA/Exercices/1.-SVM-basic-study/Data/ex6data2.mat")
...
data = loadmat("D:/OneDrive/Documents/PostCPGE/PHELMA 2020-2023/BIOMED 2022-2023/Machine Learning/Sequence-4-SVM-Kmeans-PCA/Exercices/1.-SVM-basic-study/Data/ex6data3.mat")
...
ytrainpredict=clf.predict(X)
ytestpredict=clf.predict(Xval)

print("Accuracy score: ",accuracy_score(yval,ytestpredict))
print("Precision score: ",precision_score(yval,ytestpredict))
print("Recall score: ",recall_score(yval,ytestpredict))
